...
void main ()
{
  ...
  vec3 worldPos_4;
  float dpth_5;
  dpth_5 = (1.0/(((_ZBufferParams.x * texture2D (_CameraDepthTexture, xlv_TEXCOORD2).x) + _ZBufferParams.y)));
  vec4 tmpvar_6;
  tmpvar_6.w = 1.0;
  tmpvar_6.x = ((xlv_TEXCOORD2.x * 2.0) - 1.0);
  tmpvar_6.y = ((xlv_TEXCOORD2.y * 2.0) - 1.0);
  tmpvar_6.z = ((texture2D (_CameraDepthTexture, xlv_TEXCOORD2).x * 2.0) - 1.0);
  vec4 tmpvar_7;
...
void main ()
{
  ...
  highp float dpth_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture2D (_CameraDepthTexture, xlv_TEXCOORD2);
  highp float z_8;
  z_8 = tmpvar_7.x;
  dpth_6 = (1.0/(((_ZBufferParams.x * z_8) + _ZBufferParams.y)));
  lowp float tmpvar_9;
  tmpvar_9 = texture2D (_CameraDepthTexture, xlv_TEXCOORD2).x;
  depth_5 = tmpvar_9;
...
void main ()
{
  ...
  highp float dpth_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture (_CameraDepthTexture, xlv_TEXCOORD2);
  highp float z_8;
  z_8 = tmpvar_7.x;
  dpth_6 = (1.0/(((_ZBufferParams.x * z_8) + _ZBufferParams.y)));
  lowp float tmpvar_9;
  tmpvar_9 = texture (_CameraDepthTexture, xlv_TEXCOORD2).x;
  depth_5 = tmpvar_9;
  highp vec4 tmpvar_10;
  tmpvar_10.w = 1.0;
  tmpvar_10.x = ((xlv_TEXCOORD2.x * 2.0) - 1.0);
...
dcl_2d s2
dcl_2d s3
def c26, -0.99000001, 1.00000000, 0.00000000, 2.00000000
def c27, 2.00000000, -1.00000000, 4.00000000, 0.01000000
def c28, 10.00000000, -2.00000000, 2.71828198, 0.89999998
def c29, 0.98000002, 0.02000000, 0.15000001, 12.26193905
def c30, -0.01348047, 0.05747731, -0.12123910, 0.19563590
def c31, -0.33299461, 0.99999559, 1.57079601, 0.66666669
def c32, 0.20000000, 0.83333331, 0.50000000, -2.69000006
def c33, 5.00000000, 1.50000000, 22.70000076, 1.00000000
def c34, 1000000015047466200000000000000.00000000, 600.00000000, 0.00400000, -0.19750001
def c35, 5.34960032, 0.90909088, 0.74000001, -0.00400000
def c36, 124.99999237, 16.00000000, -1.50000000, 50.00000000
def c37, 2.00000000, 3.00000000, 0.00010000, 0.38317001
def c38, 0.45454544, -1.41299999, 0, 0
dcl_texcoord2 v0.xy
texld r0.x, v0, s0
mov r4.z, r0.x
mad r0.x, r0, c4, c4.y
...
cmp_pp r1.y, r0.w, c26, c26.z
cmp r1.x, r0.w, r1, c27.y
rsq r0.w, r0.w
mul r1.z, r0, c26.w
rcp r0.z, r0.w
add r0.y, -r0, -r0.z
...
cmp r9.w, -r1.x, c26.z, c26.y
abs_pp r0.y, r9.w
cmp_pp r0.y, -r0, c26, c26.z
cmp r0.x, r0, c26.y, c26.z
mul_pp r1.y, r0.x, r0
cmp_pp r0, -r1.y, r2, c26.z
mov_pp r2, r0
cmp_pp r8.w, -r1.y, c26.y, c26.z
mov_pp oC0, r0
if_gt r8.w, c26.z
add r0.xyz, r8, -c25
mul r1.xyz, r1.x, r0
...
mul r1.x, r1, r1.w
mul r1.w, r1.x, r1.x
mad r4.x, r1.w, c30, c30.y
mad r4.x, r4, r1.w, c30.z
mad r4.x, r4, r1.w, c30.w
mad r4.x, r4, r1.w, c31
mad r1.w, r4.x, r1, c31.y
mul r1.w, r1, r1.x
mov r1.x, c7
add r1.x, -c6, r1
add r4.x, -r1.w, c31.z
...
mul r0.y, r0, r0
mul r0.x, r0.y, r0
mad r5.x, r0, c29, c29.y
rcp r0.w, c21.x
mad r0.z, -r0, r0, c26.y
mul r0.z, r0, r0.w
mul r0.z, r0, r4.w
mul r4.w, r0.z, c28.y
pow r0, c28.z, r4.w
...
rcp r1.w, c5.x
mul r5.xyz, r0, r1.w
cmp r0.x, -r4.w, c26.z, r3
mad r3.xyz, r0.x, r4, r5
mul r0.xyz, r1, r1.w
mad r9.xyz, r0, c28.x, r3
endif
endif
add r0.xyz, r8, -c25
dp3 r0.w, r0, r0
...
rsq r3.z, r3.x
rcp r3.z, r3.z
cmp r3.x, r3, r3.z, c34
add r3.x, -r3.w, -r3
max r4.y, r3.x, c26.z
add r4.z, r4.y, -r4.w
cmp r5.x, r4.z, c26.z, c26.y
cmp r4.z, -r4.y, c26, c26.y
mul_pp r4.z, r4, r5.x
...
min r0.x, r1.y, c26.y
mul r1.z, r0.x, r0.y
add r0.x, r11.w, c29.z
mul r1.w, r0.x, c29
mul r3.y, r1.z, r1.z
mad r0.x, r3.y, c30, c30.y
mad r0.y, r0.x, r3, c30.z
abs r3.x, r1.w
mad r0.z, r0.y, r3.y, c30.w
max r0.x, r3, c26.y
rcp r0.y, r0.x
min r0.x, r3, c26.y
mul r0.y, r0.x, r0
mad r0.x, r0.z, r3.y, c31
mad r3.y, r0.x, r3, c31
mul r0.z, r0.y, r0.y
mul r1.z, r3.y, r1
mad r0.x, r0.z, c30, c30.y
mad r0.x, r0, r0.z, c30.z
mad r0.x, r0, r0.z, c30.w
add r3.y, -r1.z, c31.z
add r1.y, r1, c27
cmp r1.y, -r1, r1.z, r3
cmp r1.y, r1.x, r1, -r1
mad r1.x, r0, r0.z, c31
mad r0.z, r1.x, r0, c31.y
mul r3.y, r0.z, r0
mul r0.x, r1.y, c31.w
add r1.x, r0.w, -c6
rcp r3.z, r1.x
...
mov r3.xyz, c26.yzzw
rsq r12.z, r0.z
mad r3.w, -r1, c32.z, c32.z
mad r4.w, r1, c32.z, c32.z
add r13.z, -r1.w, c32
mov r4.x, c27.y
rcp r7.x, c11.x
mul r11.z, r16.x, r5.x
add r15.z, -r13.y, c26.y
mul r14.z, r16.x, r17.x
mad r16.y, r16.x, r16.x, r0.x
mul r16.z, r16.x, r15.w
mul r0.x, r16.z, r5
mad r0.x, r0, c26.w, r16.y
rsq r0.x, r0.x
...
rsq r1.x, r1.x
cmp r0.y, -r1.z, c26.z, c26
cmp r0.x, r1.y, c26.z, c26.y
mul_pp r0.x, r0, r0.y
rcp r0.y, r12.z
mul r4.y, r0, r0
mov r4.z, r0.y
...
add r0.w, c27.y, r0
add r0.z, r12.w, c26.y
mul r0.z, r0, r0.w
mul r0.z, r0, c32
frc r15.x, r0.z
add r7.y, r0.z, -r15.x
mad r0.w, r0.y, c32.z, r7.y
...
mad r14.x, c6, c6, r0
cmp r0.y, -r14.x, c26.z, c26
cmp r0.x, r11.z, c26.z, c26.y
mul_pp r0.x, r0, r0.y
cmp r0, -r0.x, r4, r3
add r0.y, r0, r14.x
rsq r0.y, r0.y
...
mad r0.z, r1, c30.x, c30.y
mad r0.z, r0, r1, c30
mul r0.w, r15.z, r0
mad r0.z, r0, r1, c30.w
mad r1.w, r13.y, c32.z, r0
mad r0.w, r0.z, r1.z, c31.x
mul r0.z, r1.w, c8.x
mad r0.w, r0, r1.z, c31.y
mul r0.w, r0, r1.y
add r1.z, r0, c27.y
frc r16.w, r0.z
add r1.y, -r0.w, c31.z
...
cmp r1.x, r14.z, c26.z, c26.y
cmp r1.y, -r17, c26.z, c26
mov r0.y, r7
mov r7.z, c26
...
mul r0, r16.w, r0
add r7.x, -r16.w, c26.y
mad r1, r6, r7.x, r0
mad r6.y, r13, r7, r11.z
mul r7.y, r16.z, r17.x
mad r7.y, r7, c26.w, r16
rsq r7.z, r7.y
rcp r7.y, r7.z
...
mul r0, r16.w, r0
mad r0, r7.x, r6, r0
cmp r1.y, -r7.w, c26.z, c26
cmp r1.x, r7.z, c26.z, c26.y
mul_pp r1.x, r1, r1.y
cmp r1, -r1.x, r4, r3
...
mul r1.y, r0.w, r0.w
mov r1.z, r0.w
mad r1.w, r4.x, c32.z, c32.z
rcp r11.y, c11.x
cmp r0.y, -r4.z, c26.z, c26
cmp r0.x, r4.y, c26.z, c26.y
mul_pp r3.x, r0, r0.y
mov r1.x, c27.y
mad r0.w, -r4.x, c32.z, c32.z
mov r0.xyz, c26.yzzw
cmp r3, -r3.x, r1, r0
add r3.y, r3, r4.z
...
mul r3.w, r3.x, r3.x
mul r4.x, r12.y, r4.z
add r14.x, -r11.w, c26.y
mul r4.x, r14, r4
mad r4.y, r11.w, c32.z, r4.x
mul r5.x, r4.y, c8
add r4.y, r5.x, c27
frc r14.y, r5.x
frc r4.z, r4.y
...
mad r4.x, r4, r3.w, c30.z
mad r4.x, r4, r3.w, c30.w
mad r4.x, r4, r3.w, c31
mad r3.w, r4.x, r3, c31.y
mul r3.w, r3, r3.x
mul r4.x, r11.w, r4.y
...
mov r3.x, c11
add r3.y, c27, r3.x
add r3.x, r12.w, c26.y
mul r3.x, r3, r3.y
cmp r3.y, r3.z, r3.w, -r3.w
mul r3.x, r3, c32.z
frc r11.x, r3
add r6.w, -r11.x, c26.y
add r13.y, r3.x, -r11.x
mov r7.y, r6
mad r3.y, r3, c35, c35.z
add r13.x, -r12.z, c26.y
mad r3.x, r13, r3.y, r12.z
mad r3.x, r3, c32.z, r13.y
add r3.z, r3.x, c26.y
mul r6.x, r11.y, r3.z
mul r7.x, r11.y, r3
mov r3.y, r4
...
mul r4, r11.x, r4
cmp r6.y, -r7, c26.z, c26
cmp r6.x, r7, c26.z, c26.y
mul_pp r6.x, r6, r6.y
cmp r0, -r6.x, r1, r0
mad r1, r6.w, r3, r4
add r0.y, r0, r7
rsq r0.y, r0.y
add r3.x, -r14.y, c26.y
mul r1, r14.y, r1
mad r1, r5, r3.x, r1
rcp r0.y, r0.y
mad r3.x, r7, r0, r0.y
...
mul r3.y, r12, r3
mul r3.y, r3, r14.x
mad r3.y, r11.w, c32.z, r3
mul r3.y, r3, c8.x
mad r4.x, r3.z, r13.z, r0.w
mul r0.z, r0, r3.x
mul r0.w, r0.z, r0.z
mad r3.x, r0.w, c30, c30.y
mad r3.x, r3, r0.w, c30.z
mad r3.x, r3, r0.w, c30.w
mad r3.x, r3, r0.w, c31
mad r0.w, r3.x, r0, c31.y
frc r5.w, r3.y
mul r0.z, r0.w, r0
add r3.x, r3.y, -r5.w
mul r3.x, r11.w, r3
...
mul_sat r1.x, r13.w, c36.w
mad r1.y, -r1.x, c37.x, c37
max r1.w, r0.x, c37.z
mul r1.x, r1, r1
mul r1.x, r1, r1.y
mul r1.x, r0.w, r1
...
add r0.x, -r0, c26.y
add r0.y, r1.x, -c20.x
cmp r3.w, -r0.y, r0.x, c26.y
abs r0.z, r0
cmp r0.y, -r0.z, c26, c26.z
