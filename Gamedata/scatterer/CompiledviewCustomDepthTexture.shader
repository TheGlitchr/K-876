// Compiled shader for all platforms, uncompressed size: 7.6KB
...
void main ()
{
  mediump vec4 c_1;
  lowp vec4 tmpvar_2;
  tmpvar_2 = texture2DProj (_DepthTex, xlv_TEXCOORD1);
...
void main ()
{
  mediump vec4 c_1;
  lowp vec4 tmpvar_2;
  tmpvar_2 = textureProj (_DepthTex, xlv_TEXCOORD1);
  highp float tmpvar_3;
  highp float z_4;
  z_4 = tmpvar_2.x;
  tmpvar_3 = (1.0/(((_ZBufferParams.x * z_4) + _ZBufferParams.y)));
...
BindCB  "UnityPerCamera" 0
"ps_4_0
eefiecednhbhhjaneofgngohnkheociiafoafgpmabaaaaaamaabaaaaadaaaaaa
...
eaaaaaaaeaaaaaaafjaaaaaeegiocaaaaaaaaaaaaiaaaaaafkaaaaadaagabaaa
...
agaabaaaaaaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaaaaaaiadpdoaaaaab
"
}
SubProgram "gles " {
"!!GLES"
